<template>
  <div id="avaliable_terminals">
    ...
    <div class="terminals" v-if="terminals">
      <LocalAvailableTerminalItem v-for="(terminal, index) in terminals" :key="index" :data="terminal"/>
...
<script>
  import LocalAvailableTerminalItem from "./available-terminals-item";
  import apiRequest from "@/utils/apiRequest";
  export default {
    components: { LocalAvailableTerminalItem },
    data(){
      return {
        terminals: null,
        showButtons: true,
