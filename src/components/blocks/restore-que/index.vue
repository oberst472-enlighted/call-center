<template>
    <div id="restoreQue">
        ...
        <div class="calls-list" v-if="requestsList.length > 0">
            ...
            <!--      <BlockUserHistory v-for="operator in operators" :key="operator._id" :data="operator"/>-->
        </div>
...
<script>
import BlockUserHistory from "@/components/blocks/user-history";
import apiRequest from "@/utils/apiRequest";
export default {
    components: {BlockUserHistory},
    data() {
        return {
            requestsList: [],
