        ...
        <div class="sidebar" :class="{'call-active': $store.state.callLogic.isCallInProgress}">
            <div class="call-window">
                <div class="call-window-head" v-if="$store.state.callLogic.incomingData">
                    <div class="call-window-head-new">НОВЫЙ ЗВОНОК <span>{{
                            $store.state.callLogic.incomingData.lang
                                                                         }}</span>
                    </div>
                    <div class="call-window-head-name">{{ $store.state.callLogic.incomingData.station }}</div>
                    <div class="call-window-head-terminal">терминал #{{
                            $store.state.callLogic.incomingData.stationId
                                                           }}
                    </div>
            ...
            <div class="col">
                <div class="call-timer">
                    ...
                    <div class="call-timer-wrapper" v-else>
                        ...
                        <div class="call-timer-time">{{ $store.state.callLogic.startTime }} -
                                                     {{ $store.state.callLogic.endTime }}
                        </div>
                    </div>
                </div>
