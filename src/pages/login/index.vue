<template>
    <div class="page-login">
        ...
        <!--&lt;!&ndash;                    <div class="icon-user__box">&ndash;&gt;-->
        <!--&lt;!&ndash;                        <IconUser/>&ndash;&gt;-->
        <!--&lt;!&ndash;                    </div>&ndash;&gt;-->
        <!--&lt;!&ndash;                </div>&ndash;&gt;-->
        <!--&lt;!&ndash;                <input class="input-field" type="text" v-model="login"/>&ndash;&gt;-->
        <!--&lt;!&ndash;            </div>&ndash;&gt;-->
        <!--            <div class="input">-->
        <!--                <div class="input-icon" @click="togglePassType">-->
        <!--                    <div class="icon-user__box">-->
        <!--                        <IconKey/>-->
        <!--                    </div>-->
        <!--                </div>-->
...
import SectionLogin from '@/components/sections/login-form'
export default {
    components: {
        SectionBox,
        SectionLogin
